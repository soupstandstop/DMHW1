...
def createTree(dataSet, minSup=0.2):
...
def mineTree(inTree, headerTable, minSup, preFix, freqItemList):
    ...
    # print ('-----', sorted(headerTable.items(), key=lambda p: p[1].count))
    # print ('bigL=', bigL)
...
if __name__ == "__main__":
    ...
    freqItemList = []
    i = 0
    mineTree(myFPtree, myHeaderTab, 80, set([]), freqItemList)
